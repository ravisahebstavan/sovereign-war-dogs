      ...
      <div style={{ width: "100%", maxWidth: 500, padding: "0 24px" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 52 }}>
          ...
          <div style={{
            ...
            Keys are stored locally on your machine — never sent anywhere.
          </div>
        </div>
        ...
        <Field
          ...
          hint="Free tier — 60 API calls/min. Used for live news and price feeds."
        />
        ...
        <Field
          ...
          hint="Paper trading only — no real money. Find your keys under API Keys in the Alpaca dashboard."
        />
        ...
        >
          {loading ? "LAUNCHING SOVEREIGN…" : "LAUNCH SOVEREIGN →"}
        </button>

        {/* Footer note */}
        <div style={{ marginTop: 32, textAlign: "center", fontSize: 10, color: "#222", lineHeight: 1.8 }}>
          Keys are written to your local app config folder.<br />
